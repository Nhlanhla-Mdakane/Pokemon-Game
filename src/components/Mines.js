...
//this Component is where the first stage of the game takes place
import winImg from "./images/win1.jpg";
...
class Mines extends React.Component {
  ...
  safe(e) {
    ...
    if (this.props.newCountAmount === 5) {
